...
print u'日期时间%%c: %s ' % dt.strftime('%c')
#print: 日期%x：09/12/12
print u'日期%%x：%s ' % dt.strftime('%x')
#print: 时间%X：23:04:27
print u'时间%%X：%s ' % dt.strftime('%X')
#print: 今天是这周的第3天
print u'今天是这周的第%s天 ' % dt.strftime('%w')
#print: 今天是今年的第256天 
print u'今天是今年的第%s天 ' % dt.strftime('%j')
#print: 今周是今年的第37周
print u'今周是今年的第%s周 ' % dt.strftime('%U')